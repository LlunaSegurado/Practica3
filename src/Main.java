...
public class Main {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 2:
                    ...
                    String result = Encrypt.insertEncryption(textClean, k1, k2, n);
                ...
                case 3:
                    ...
                    String result2 = Decrypt.decryption(textClean2, n,k1 ,k2);
    ...
    private static void defineAlgorithm() {
